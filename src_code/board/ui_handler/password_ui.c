...
Item Password_Item[] =
{
    {INPUT_PASSWD_TEXT_START_X, INPUT_PASSWD_TEXT_START_Y, "请输入密码", BLACK, BLACK, INPUT_PASSWD_TEXT_FONT, 1},		//0  隐藏
    {INPUT_PASSWD_TEXT_START_X, INPUT_PASSWD_TEXT_START_Y, "请输入密码", WHITE, BLACK, INPUT_PASSWD_TEXT_FONT, 1},		//1  显示
};

Item Password_Error_Item[] =
{
    {PASSWD_ERROR_TEXT_START_X, PASSWD_ERROR_TEXT_START_Y, "密码错误", BLACK, BLACK, PASSWD_ERROR_TEXT_FONT, 1},		//0  隐藏
    {PASSWD_ERROR_TEXT_START_X, PASSWD_ERROR_TEXT_START_Y, "密码错误", RED, BLACK, PASSWD_ERROR_TEXT_FONT, 1},			//1  显示

    {RETRY_INPUT_TEXT_START_X, RETRY_INPUT_TEXT_START_Y, "请重新输入", BLACK, BLACK, RETRY_INPUT_TEXT_FONT, 1},		//2  隐藏
    {RETRY_INPUT_TEXT_START_X, RETRY_INPUT_TEXT_START_Y, "请重新输入", RED, BLACK, RETRY_INPUT_TEXT_FONT, 1},			//3  显示
};
...
void password_input_error_display(int enable)
{
    if(enable == 1)
    {
        display_menu_color_item(Password_Error_Item, 1, Password_Error_Item[1].front_color);
        display_menu_color_item(Password_Error_Item, 3, Password_Error_Item[3].front_color);
    }
    else if(enable == 0)
    {
        display_menu_color_item(Password_Error_Item, 0, Password_Error_Item[0].front_color);
        display_menu_color_item(Password_Error_Item, 2, Password_Error_Item[2].front_color);
    }
}
